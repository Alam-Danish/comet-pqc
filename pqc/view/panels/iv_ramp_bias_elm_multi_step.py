...
__all__ = ["IVRampBiasElmMultiStepPanel"]


class IVRampBiasElmMultiStepPanel(MatrixPanel):
    """Panel for bias IV ramp measurements."""

    def __init__(self, parent: Optional[QtWidgets.QWidget] = None) -> None:
        super().__init__(parent)
        self.setName("IV Ramp Bias Elm Multi Step")
        ...
        self.v1StopSpinBox = QtWidgets.QDoubleSpinBox(self)
        self.v1StopSpinBox.setDecimals(3)
        self.v1StopSpinBox.setRange(-2200, +2200)
        self.v1StopSpinBox.setSuffix(" V")

        self.v2StopSpinBox = QtWidgets.QDoubleSpinBox(self)
        self.v2StopSpinBox.setDecimals(3)
        self.v2StopSpinBox.setRange(-2200, +2200)
        self.v2StopSpinBox.setSuffix(" V")

        self.coarsevoltageStepSpinBox = QtWidgets.QDoubleSpinBox(self)
        self.coarsevoltageStepSpinBox.setDecimals(3)
        self.coarsevoltageStepSpinBox.setRange(0, 200)
        self.coarsevoltageStepSpinBox.setSuffix(" V")

        self.finevoltageStepSpinBox = QtWidgets.QDoubleSpinBox(self)
        self.finevoltageStepSpinBox.setDecimals(3)
        self.finevoltageStepSpinBox.setRange(0, 200)
        self.finevoltageStepSpinBox.setSuffix(" V")
        ...
        self.bind("v1_stop", self.v1StopSpinBox, 0, unit="V")
        self.bind("v2_stop", self.v2StopSpinBox, 0, unit="V")
        self.bind("voltage_stop", self.voltageStopSpinBox, 0, unit="V")
        self.bind("coarse_voltage_step", self.coarsevoltageStepSpinBox, 0, unit="V")
        self.bind("fine_voltage_step", self.finevoltageStepSpinBox, 0, unit="V")
        ...
        rampGroupBoxLayout.addWidget(QtWidgets.QLabel("v1 Stop"))
        rampGroupBoxLayout.addWidget(self.v1StopSpinBox)
        rampGroupBoxLayout.addWidget(QtWidgets.QLabel("v2 Stop"))
        rampGroupBoxLayout.addWidget(self.v2StopSpinBox)
        rampGroupBoxLayout.addWidget(QtWidgets.QLabel("Stop"))
        rampGroupBoxLayout.addWidget(self.voltageStopSpinBox)
        rampGroupBoxLayout.addWidget(QtWidgets.QLabel("Coarse Step"))
        rampGroupBoxLayout.addWidget(self.coarsevoltageStepSpinBox)
        rampGroupBoxLayout.addWidget(QtWidgets.QLabel("Fine Step"))
        rampGroupBoxLayout.addWidget(self.finevoltageStepSpinBox)
